  ...
  <div id="nav px-2">
    <nav class="flex items-center justify-between flex-wrap bg-blue p-6">
      <div class="flex items-center flex-no-shrink text-white mr-6">
        ...
        <span class="font-semibold text-xl tracking-tight">Dogfather</span>
      </div>
      ...
      <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
        <div class="text-sm lg:flex-grow">
          <router-link :to="{ name: 'home' }" tag="a" class="block mt-4 lg:inline-block lg:mt-0 text-blue-lighter hover:text-white mr-4">Home</router-link>
          <router-link :to="{ name: 'about' }" tag="a" class="block mt-4 lg:inline-block lg:mt-0 text-blue-lighter hover:text-white mr-4">About</router-link>
        </div>
        <div>
