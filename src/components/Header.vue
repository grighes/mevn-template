  ...
  <nav class="flex items-center justify-between flex-wrap bg-teal p-6">
    ...
    <div :class="open ? 'block': 'hidden'" class="w-full flex-grow sm:flex sm:items-center sm:w-auto">
      <div class="text-sm sm:flex-grow">
        <router-link :to="{ name: 'home' }" tag="a" class="no-underline block mt-4 sm:inline-block sm:mt-0 text-teal-lighter hover:text-white mr-4">Home</router-link>
        <router-link :to="{ name: 'about' }" tag="a" class="no-underline block mt-4 sm:inline-block sm:mt-0 text-teal-lighter hover:text-white mr-4">About</router-link>
